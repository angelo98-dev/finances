...
abstract class $TransactionCopyWith<$Res> {
  ...
  @useResult
  $Res call({DateTime date, bool isOutcome, double amount});
}
...
class _$_Transaction extends _Transaction {
  const _$_Transaction(
      {required this.date, required this.isOutcome, required this.amount})
      : super._();
  ...
  @override
  String toString() {
    return 'Transaction(date: $date, isOutcome: $isOutcome, amount: $amount)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, date, isOutcome, amount);
