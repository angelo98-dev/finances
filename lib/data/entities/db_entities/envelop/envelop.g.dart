...
Envelop _envelopDeserialize(
  ...
  object.id = id;
  object.initAmount = reader.readDouble(offsets[1]);
...
extension EnvelopQueryFilter
  ...
  QueryBuilder<Envelop, Envelop, QAfterFilterCondition> transactionsIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Envelop, Envelop, QAfterFilterCondition> transactionsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'transactions',
        0,
...
extension EnvelopQueryObject
    on QueryBuilder<Envelop, Envelop, QFilterCondition> {
  QueryBuilder<Envelop, Envelop, QAfterFilterCondition> transactionsElement(
...
extension EnvelopQueryProperty
  ...
  QueryBuilder<Envelop, List<Transaction>?, QQueryOperations>
